...
def count_words():
    ...
    html = "<html><head><title>Cool</title></head><body><h1>" + words + "</h1></body></html>"
    ...
    span = ""    
    for word in words:
        span = span + <span style="font-size: 16px; color: #017e22">word</span>
    html = "<html><head><title>Cool</title></head><body><h1>" + words + "</h1></body></html>"
...
import nltk from nltk import FreqDist 
